...
3. For every path, add an edge between vertices f and t with capacity C-c. Connect t to source with capacity c to enforce minimum. Connect f to sink with capacity c to enforce maximum. Add c to the flow_needed variable.
